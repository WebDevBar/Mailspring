...
const start = () => {
  ...
  // on non-GNOME/KDE desktops (e.g. Hyprland, Sway, i3), and after some KDE
  // updates the kwallet6 backend can report encryption unavailable. If the user
  // hasn't explicitly set --password-store, check if a Secret Service provider
  // is available on D-Bus and use gnome-libsecret.
  // Backport of upstream PR #2660 (Foundry376/Mailspring).
  if (
